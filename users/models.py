...
def validate_birth_date(value):
    if value > date(2008, 12, 31):
        raise ValidationError("Birth date cannot be later than 2008.")
...
class Customer(models.Model):
 ...
 birth = models.DateField(null=True, blank=True, validators=[validate_birth_date])
